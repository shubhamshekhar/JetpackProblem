class Jetpack {
	...
	private static void instructionToPassArgument(){
		...
		System.out.println("* If you need to pass number of compartment as 5 and threshold value of each of the compartment as 2,3,1,1,3 and the compartment number with thesis as 5, then pass command line argument as following:");
		System.out.println("5 {2,3,1,1,3} 5");
	}
